...
```
exec: bash -c 'nohup bash /Users/leo/Agents/imagecreator-workspace/bin/poll_and_send.sh /Users/leo/Agents/imagecreator-workspace/inbox/ic-<id>.json <prompt_id> <workflow> "<prompt_text>" > /tmp/poll_<id>.log 2>&1 & echo "background PID=$!"'
```
