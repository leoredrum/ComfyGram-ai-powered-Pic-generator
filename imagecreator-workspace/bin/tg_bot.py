#!/usr/bin/env python3
"""
@artistleobot — ImageCreator 专属 Telegram Bot
直连 ComfyUI，无内容过滤。
...
# ── 配置 ────────────────────────────────────────────────
BOT_TOKEN   = "8651171658:AAHFt5V0xDcfuuH-8DYd6m4KeqPS5X3TNbw"
...
WORKSPACE          = Path("/Users/leo/Agents/imagecreator-workspace")
COMFYUI_INPUT      = Path("/Users/leo/Documents/ComfyUI/input")
COMFYUI_OUTPUT     = Path("/Users/leo/Documents/ComfyUI/output")
MEDIA_OUTPUT       = WORKSPACE / "media" / "output"
MEDIA_INPUT        = WORKSPACE / "media" / "input"
OUTPUT_ARCHIVE     = Path("/Users/leo/Documents/ComfyUI_output_archive")
MATERIAL_REGISTRY_FILE = WORKSPACE / "material_registry.json"
LORA_REGISTRY_FILE = WORKSPACE / "lora_registry.json"  # kept for compat

# tmp files
OFFSET_FILE   = WORKSPACE / "tmp" / "artistleobot_offset.json"
PENDING_FILE  = WORKSPACE / "tmp" / "artistleobot_pending.json"
WAITING_FILE  = WORKSPACE / "tmp" / "artistleobot_waiting.json"
TRAINING_FILE = WORKSPACE / "tmp" / "artistleobot_training.json"
...
def _run_wd14_tag(image_local_path: Path, timeout: int = 300) -> str:
    ...
    py = "/Users/leo/Documents/ComfyUI/.venv/bin/python3"
    try:
...
# ── Main polling loop ─────────────────────────────────────
PID_FILE = WORKSPACE / "tmp" / "artistleobot.pid"
...
def main():
    ...
    print(f"[bot] @artistleobot starting... pid={os.getpid()}", flush=True)
